    ...
    <header className="sticky top-0 z-30 backdrop-blur-xl bg-[var(--color-bg)]/70 border-b border-[var(--color-line)]">
      <div className="max-w-[1480px] mx-auto px-4 sm:px-6 h-16 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {onAdmin && (
            <button onClick={onAdmin} className="btn-ghost w-9 h-9 grid place-items-center" title="Coach dashboard" style={{ borderColor: "var(--color-volt)", color: "var(--color-volt)" }}>
              <CoachIcon />
            </button>
          )}
...
const FormIcon = () => (<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M23 7l-7 5 7 5V7z" /><rect x="1" y="5" width="15" height="14" rx="2" /></svg>);
